...
class AppColors {
  ...
  static const Color primary = Color(0xFF0c3c15);
  static const Color primaryLight = Color(0xFFa8e665);
  ...
  static const Color darkPrimaryLight = Color(0xFFBB86FC); // You might want a different shade for dark mode
